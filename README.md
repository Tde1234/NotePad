...
- 新建笔记显示效果
  ...
  <img src="./运行结果截图/新建笔记.png" width="420" alt="新建笔记显示效果" />
  
- 编辑笔记显示效果
  (1)点击“新建笔记”或者长按笔记列表中的任意笔记项，进入编辑界面
  (2)在编辑界面中，用户可以修改笔记的分类，标题和内容

  <img src="./运行结果截图/编辑笔记.png" width="420" alt="编辑笔记显示效果" />
...
- 新增笔记成功显示效果
  ...
  <img src="./运行结果截图/笔记新增成功.png" width="420" alt="新增笔记成功显示效果" />
### 2.编辑标题
- **功能介绍**：用户可以为笔记设置标题
...
- 编辑标题显示效果
  ...
  <img src="./运行结果截图/编辑标题1.png" width="420" alt="编辑标题显示效果" />

  (3)用户完成输入后，点击保存按钮
  (4)系统会将用户输入的标题保存到数据库中
  (5)返回笔记列表界面，用户可以在列表中看到更新后的标题

  <img src="./运行结果截图/编辑标题2.png" width="420" alt="编辑标题显示效果" />
...
- 笔记列表显示效果
  ...
  <img src="./运行结果截图/笔记列表.png" width="420" alt="笔记列表显示效果" />
...
- 笔记列表时间戳显示效果
  ...
  <img src="./运行结果截图/时间戳功能实现.png" width="420" alt="笔记列表时间戳显示效果" />
...
- **标题**：笔记搜索功能效果
  ...
  <img src="./运行结果截图/笔记关键词搜索.png" width="420" alt="笔记搜索功能效果" />

  <img src="./运行结果截图/笔记关键词搜索1.png" width="420" alt="笔记搜索功能效果" />

  <img src="./运行结果截图/笔记关键词搜索2.png" width="420" alt="笔记搜索功能效果" />
...
- **标题**：笔记分类管理界面
  ...
  <img src="./运行结果截图/分类管理1.png" width="420" alt="分类管理1" />

  <img src="./运行结果截图/分类管理2.png" width="420" alt="分类管理2" />

  <img src="./运行结果截图/分类管理3.png" width="420" alt="分类管理3" />

  <img src="./运行结果截图/分类管理4.png" width="420" alt="分类管理4" />
...
- **标题**：笔记分类过滤效果
  ...
  <img src="./运行结果截图/分类过滤1.png" width="420" alt="分类过滤1" />

  <img src="./运行结果截图/分类过滤2.png" width="420" alt="分类过滤2" />

  <img src="./运行结果截图/分类过滤3.png" width="420" alt="分类过滤3" />
...
- **标题**：待办事项功能效果
  ...
  <img src="./运行结果截图/待办事项.png" width="420" alt="待办事项功能效果" />

  也为笔记添加了待办选项，同样勾选后可以标记为已完成，显示删除线。
  
  <img src="./运行结果截图/笔记代办.png" width="420" alt="笔记代办效果" />
...
- **标题**：笔记背景颜色设置界面
  ...
  <img src="./运行结果截图/笔记列表.png" width="420" alt="应用主题切换效果" />

  <img src="./运行结果截图/背景颜色更改.png" width="420" alt="背景颜色更改" />

  <img src="./运行结果截图/背景颜色更改1.png" width="420" alt="背景颜色更改1" />
